# How to load Cannon in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      baseline: 'Cannon';
      repository: 'github://ba-st/Cannon:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `ba-st` as owner name and `Cannon`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Cannon ...*
